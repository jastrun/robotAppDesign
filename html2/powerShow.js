...
var myChart_power = echarts.init(document.getElementById("power"));
...
function setdata_speed(data){
    option_power.series[0].data[0].value=data
    myChart_power.setOption(option_speed);
}

let data_power

function setdata_power(data){
    data_power=data
}

setInterval(function () {
    option_power.series[0].data[0].value=data_power
